...
namespace MainApp2.Week5
{
    internal class Employee
    {
        public static void EmployeeList()
        {
            ...
            {
                new EmployeeModel{ FirstName = "Ashma", LastName = "Maharjan", Designation = "Business Analyst", PhoneNumber = "123456", Email = "ashma@gmail.com", Address="Kathmandu", HiredDate = DateTime.Now, Salary = 50000, IsManager = true},
